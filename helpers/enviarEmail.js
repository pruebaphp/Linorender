                                                                        ...
                                                                        <tr>
                                                                            <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-image es-m-p0l es-m-txt-c" align="left" style="font-size:0"><a href="https://viewstripo.email" target="_blank"><p style="display: block; color: white; font-size: 30px; font-family: 'Rubik', sans-serif;">LinoRender</p></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p40r es-p40l" align="left">
                                                                                                <p style="text-align: center;">Hola,&nbsp;¡Gracias por elegir LinoRender! Por favor, confirme su dirección de correo electrónico haciendo clic en el siguiente enlace. Le comunicaremos actualizaciones importantes de vez en cuando por correo electrónico, por lo que es esencial que tengamos una dirección de correo electrónico actualizada en el archivo.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                                                <p><b>Si no se registró para obtener una cuenta de LinoRender, simplemente puede ignorar este correo electrónico.
                                                                                                </b></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="http://localhost:5000/confirmar-cuenta/${token}" class="es-button" target="_blank">VERIFIQUE SU DIRECCIÓN DE CORREO ELECTRONICO</a></span></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
